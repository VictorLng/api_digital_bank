...
class AddFundsTest extends TestCase
{
    ...
    public function testAddFundsSuccess()
    {
    ...
    public function testAddFundsWithNegativeAmount()
    {
        $request = new Request([
        ...
        $this->customerAccountBo->addFunds($request);
    }

    public function testAddFundsWithNonExistentAccount()
    {
